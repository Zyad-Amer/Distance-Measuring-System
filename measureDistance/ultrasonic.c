...
void Ultrasonic_init(void)
{
	...
	GPIO_setupPinDirection(ULTRASONIC_TIRGGER_PORT_ID,ULTRASONIC_TIRGGER_PIN_ID,PIN_OUTPUT);
...
void Ultrasonic_Trigger(void)
{
	...
	GPIO_writePin(ULTRASONIC_TIRGGER_PORT_ID,ULTRASONIC_TIRGGER_PIN_ID,LOGIC_HIGH);
	_delay_us(10);
	GPIO_writePin(ULTRASONIC_TIRGGER_PORT_ID,ULTRASONIC_TIRGGER_PIN_ID,LOGIC_LOW);
}
